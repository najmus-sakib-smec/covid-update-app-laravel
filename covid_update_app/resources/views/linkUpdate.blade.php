                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-success">
                            ...
                            <form id="links" method="POST" action="{{ route('update')}}">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input class="form-control" id="title" name="title" value="{{$links->title}}">
                                                <br>
                                            </div>

                                            <div class="col-sm-6">
                                                <label for="inputEmail3" class="col-sm-2 col-form-label">Link</label>
                                                <input class="form-control" id="link" name="link" value="{{$links->link}}">
                                            </div>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" name="links" class="btn btn-success">Update</button>
