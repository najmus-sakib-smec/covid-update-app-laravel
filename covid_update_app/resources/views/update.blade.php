                ...
                <div class="container-fluid">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="card-body">
                                <form id="contactInfo" method="POST" action="{{ route('update')}}">
                                    @csrf
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="name" name="name" value="{{$contacts->name}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputPassword3" class="col-sm-4 col-form-label">Designation</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="designation" name="designation" value="{{$contacts->designation}}">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                            <label for="inputPassword3" class="col-sm-4 col-form-label">Email</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="email" name="email" value="{{$contacts->email}}">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                            <label for="inputPassword3" class="col-sm-4 col-form-label">Phone</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="phone" name="phone" value="{{$contacts->phone}}">
                                            </div>
                                        </div>
                                        <div class=" form-group row">
                                            <label for="inputPassword3" class="col-sm-4 col-form-label">What's App</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="whatsapp" name="whatsapp" value="{{$contacts->whatsapp}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class=" card-footer">
                                        <button type="submit" name="contacts" class="btn btn-success">Update</button>
